...
const portugueseMessages: TranslationMessages = {
	ra: {
		...
		page: {
			...
			show: '%{name} #%{id}',
			empty: 'Sem Registos',
			empty_create: 'Clique aqui para adicionar um novo registo',
		...
		message: {
			...
			access_denied: 'Access Denied',
			authentication_error: 'Authentication Error',
			select_all_limit_reached: 'Limite seleção ultrapassado',
		...
		notification: {
			...
			application_update_available: 'Atualização disponível',
			offline: 'Sem rede',
		},
		validation: {
	...
	resources: {
		animals: {
			...
			fields: {
				...
				idade: 'Idade',
				ativo: 'Ativo',
				atualizado: 'Ultima atualização',
				atualizado_por: 'Autlizado por',
			},
		},
		'app-users-sessions': {
			name: 'Sessões',
			// edit_title: 'Editar Sessão',
			// create_title: 'adicionar Sessão',
			fields: {
				app_id: 'Aplicação',
				validity: 'Validade',
			},
		...
		utilizadores: {
			...
			create_title: 'adicionar Utilizador',
